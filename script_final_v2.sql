...
------------------------------------------------------------
-- 2) LOCAL DE ESTOQUE  (ajuste de coluna: LOCATION_STOCK_NAME)
------------------------------------------------------------
CREATE TABLE LOCATION_STOCK (
  LOCATION_ID_STOCK     NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  LOCATION_STOCK_NAME   VARCHAR2(30)  NOT NULL,   -- novo nome
...
------------------------------------------------------------
-- INSERÇÃO DE DADOS (15 por tabela principal)
------------------------------------------------------------
...
--------------------------------------------------------------
-- CITY (todas no estado 1 para simplificar FKs dos bairros)
--------------------------------------------------------------
...
--------------------------------------------------------------
-- LOCATION_STOCK (ajustado: LOCATION_STOCK_NAME)
--------------------------------------------------------------
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Depósito Central', 'Armazém principal', 1);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia 1', 'Farmácia interna do hospital', 2);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia 2', 'Farmácia da ala leste', 3);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia 3', 'Farmácia pediátrica', 4);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Almoxarifado 1', 'Setor de materiais', 5);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Almoxarifado 2', 'Depósito de descartáveis', 6);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Oncológica', 'Setor de quimioterápicos', 7);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Cirúrgica', 'Armazenamento de anestésicos', 8);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Geral', 'Estoque de uso geral', 9);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia de Plantão', 'Atendimento 24h', 10);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Ambulatorial', 'Dispensação externa', 11);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Interna', 'Uso exclusivo hospitalar', 12);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia COVID', 'Setor emergencial', 13);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Especial', 'Medicamentos de alto custo', 14);
INSERT INTO LOCATION_STOCK (LOCATION_STOCK_NAME, LOCATION_DESCRIPTION, ADDRESS_ID_STOCK) VALUES ('Farmácia Regional', 'Abastecimento regional', 15);
...
------------------------------------------------------------
-- BLOCOS ANÔNIMOS COM CONSULTAS (JOIN + GROUP BY + ORDER BY)
------------------------------------------------------------
SET SERVEROUTPUT ON;
------------------------------------------------------------
-- 1) INNER JOIN — Medicamentos por Categoria
------------------------------------------------------------
DECLARE
  CURSOR c_cat IS
    SELECT
...
BEGIN
  ...
  FOR r IN c_cat LOOP
    DBMS_OUTPUT.PUT_LINE(RPAD(r.categoria, 30) || '  ->  ' || LPAD(r.total_medicamentos, 4));
  END LOOP;
END;
/

------------------------------------------------------------------
-- 2) LEFT JOIN — Totais de estoque por local (inclui vazios)
------------------------------------------------------------------
DECLARE
  CURSOR c_loc IS
    SELECT
      ls.LOCATION_ID_STOCK,
      ls.LOCATION_STOCK_NAME,
    ...
    GROUP BY ls.LOCATION_ID_STOCK, ls.LOCATION_STOCK_NAME
    ORDER BY total_estoque DESC, ls.LOCATION_STOCK_NAME;
BEGIN
  DBMS_OUTPUT.PUT_LINE('== TOTAL DE ESTOQUE POR LOCAL (inclui vazios) ==');
  FOR r IN c_loc LOOP
    DBMS_OUTPUT.PUT_LINE(
      'LocID='||LPAD(r.LOCATION_ID_STOCK,3)||'  '||
      RPAD(r.LOCATION_STOCK_NAME, 28) || '  | Itens=' ||
...
-----------------------------------------------------------------------------
-- 3) RIGHT JOIN — Endereços de estoque por cidade (todos os endereços)
-----------------------------------------------------------------------------
DECLARE
  CURSOR c_city IS
    SELECT
...
------------------------------------------------------------
-- BLOCOS ANÔNIMOS COM DML + DECISÃO (UPDATE / DELETE)
------------------------------------------------------------

-- UPDATE condicional em STOCK
DECLARE
  ...
  v_delta               NUMBER := 25; -- delta de ajuste (negativo para baixar)
...
BEGIN
  BEGIN
    ...
    SELECT QUANTITY INTO v_new_qty FROM STOCK WHERE STOCK_ID = v_stock_id;
...
--------------------------------------------------------
-- DELETE condicional em MEDICINE_DISPENSE
--------------------------------------------------------
DECLARE
